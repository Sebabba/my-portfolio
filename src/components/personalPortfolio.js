      ...
      <div className="d-flex flex-column col-lg-8">
        <div>
          ...
          <p className="project-link">
            <a
              href="https://portfolio-sebastianos-projects.vercel.app"
              target="_blank"
        ...
        <div>
          ...
          <p>
            ...
            Router library, useful to create a stable and fast implementation of
            sub-pages. Also, the build and deploy was made thanks to Vercel,
            which is perfect for React and Next.js. The portfolio is also
            responsive and works great on mobile. This was possible using
            Bootstrap.
          </p>
