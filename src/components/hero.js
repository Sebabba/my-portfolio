        ...
        <div className="justify-content-center col-lg-9">
          <div className="text-center m-1">
            ...
            <p>
              ...
              building websites and applications using React JS and Magnolia
              CMS. I also have experience in back-end development, including
              database management and AWS implementation.
            </p>
          </div>
        </div>
